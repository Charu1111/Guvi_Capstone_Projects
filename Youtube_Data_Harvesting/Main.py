...
icon = Image.open("C:\\Users\\Charu\\Desktop\\youtube logo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Charu",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Charu!*"""})
...
if SELECT == "EXTRACT AND TRANSFORM":
